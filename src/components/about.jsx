    ...
    const goals=[
        {
          ...
          icon:<QueryStatsIcon fontSize="large" style={{color:'#000000'}} />,
        },
        {
            ...
            icon:<SettingsIcon fontSize="large" style={{color:'#000000'}} />,
          },
          {
            ...
            icon:<TravelExploreIcon fontSize="large" style={{color:'#000000'}} />,
          },
          {
            ...
            icon:<PermIdentityIcon fontSize="large" style={{color:'#000000'}} />,
          },
  ...
  const coreValues = [
    {
        ...
        icon: <EmojiPeopleIcon fontSize="large" style={{color:'#000000'}} />,
    },
    {
        title: 'Innovation',
        ...
        icon: <LightbulbIcon fontSize="large"  style={{color:'#000000'}}/>,
    },
    {
        title: 'Quality',
        ...
        icon: <VerifiedIcon fontSize="large" style={{color:'#000000'}} />,
    },
    {
        ...
        icon: <RecyclingOutlinedIcon  fontSize="large"  style={{color:'#000000'}}/>,
      },
    {
        ...
        icon: <BadgeIcon fontSize="large"  style={{color:'#000000'}}/>,
    },
    {
     ...
     icon:<PeopleIcon fontSize="large" style={{color:'#000000'}}/>,
    },
    ];
    ...
    <div className='abouthead'>
        ...
        <Container sx={{ paddingY: 4 }}>
            ...
            <Section >
                <Typography style={{fontSize:'36px',color:'#333'}} gutterBottom>About Pioxno</Typography>
...
<Container sx={{ paddingY: 4 }}>
            {/* Mission Section */}
            <Section>
                <Typography variant="h4" component="h2" gutterBottom  style={{ color:'#000000', fontWeight:'600', fontFamily:'serif'}}> <TrackChangesIcon style={{fontSize:'large'}}/> Mission  </Typography>
            ...
            {/* Vision Section */}
            <Section>
                <Typography variant="h4" component="h2" gutterBottom style={{ color:'#000000', fontWeight:'600', fontFamily:'serif'}}> <VisibilityIcon style={{fontSize:'large'}}/> Vision</Typography>
                <Typography variant="body1" style={{fontSize:'13px'}} >
            ...
            {/* Core Values Section */}
            <Section>
                <Typography variant="h4" component="h2" gutterBottom style={{ color:'#000000', fontWeight:'600', fontFamily:'serif'}}> <DiamondIcon style={{fontSize:'large'}}/> Core Values</Typography>
            ...
            {/* Why Join Section */}
            <Section>
                <Typography variant="h4" component="h3" gutterBottom style={{ color:'#000000', fontWeight:'700', fontFamily:'serif'}}>Why Join Pioxno?</Typography>
